...
describe("Filters", () => {
  ...
  test("Filter by tenloaiSP for LoaiSp", async () => {
  ...
  test("Filter by tenSP for Sanpham", async () => {
  ...
  test("Filter by username for User", async () => {
  ...
  test("Filter by tenKhuyenMai for Khuyenmai", async () => {
  ...
  test("Filter by username for Hoadon", async () => {
